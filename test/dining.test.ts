...
const validLocation = [
  {
    ...
    name: "Main Hall",
    is_building: false,
    pay_with_meal_swipe: true,
    pay_with_retail_swipe: false,
    week: [
      {
        date: "2023-10-27",
        hours: [
          { start_hour: 8, start_minutes: 0, end_hour: 20, end_minutes: 0 },
        ],
        status: "open",
      },
    ...
    week: [
      {
        date: "2023-10-27",
        hours: [
          { start_hour: 10, start_minutes: 0, end_hour: 18, end_minutes: 0 },
        ],
        status: "open",
      },
      { date: "2023-10-28", hours: [], status: "closed" },
  ...
  },
  {
    ...
    pay_with_retail_swipe: true,
    week: [
      {
        date: "2023-10-27",
        hours: [
          { start_hour: 11, start_minutes: 0, end_hour: 22, end_minutes: 0 },
        ],
        status: "open",
      },
      { date: "2023-10-28", hours: [], status: "closed" },
...
const mockEmptyLocationsExpected = {
  ok: false,
  error: {
    kind: "upstream",
    message:
